                ...
                </div>
                {
                    ...
                    <>
                        <div>
                            ...
                            <input id="name" type="name" placeholder="Enter name" value={name} onChange={e => setName(e.target.value)}></input>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input id="password" type="password" placeholder="Confirm password" onChange={e => setConfirmPassword(e.target.value)}></input>
                        </div>
                        {
                            user.isSeller && (
                                <>
                                    ...
                                    <div>
                                        <label htmlFor="imageFile">Logo from Computer</label>
